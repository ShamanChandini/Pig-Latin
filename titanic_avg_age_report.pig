titanic_data = load 'C:/Users/schan/Downloads/Big_DataHadoop_Projects-master/Big_DataHadoop_Projects-master/titanic_data_analysis/TitanicData.txt' using PigStorage(',') as (PassengerId:int,Survived:int,Pclass:int,Name:chararray,Sex:chararray,Age:int,SibSp:int,Parch:int,Ticket:chararray,Fare:int,Cabin:chararray,Embarked:chararray);

store titaic_data into 'output1'
